	...
	?>
		<nav class="custom-navbar navbar navbar-expand-md navbar-dark sticky-top" arial-label="Furni navigation bar">
			<div class="container">
				<a class="navbar-brand" href="/marketplace/client/index.php">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						<li id="home"><a class="nav-link" href="/marketplace/client/index.php">Home</a></li>
						<li id="shop"><a class="nav-link" href="/marketplace/client/shop.php">Shop</a></li>
						<li id="about"><a class="nav-link" href="/marketplace/client/about.php">About us</a></li>
						<li id="contact"><a class="nav-link" href="/marketplace/client/contact.php">Contact us</a></li>
					</ul>
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5 d-flex align-items-center">
						<li class="me-3">
							...
							<a class="nav-link" href="/marketplace/client/cart.php">
						...
						<li class="me-3">
							...
							<a class="nav-link" href="/marketplace/vendor/convert.php">
						...
						<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									<li><a class="dropdown-item" href="/marketplace/vendor/dashboard.php">Dashboard</a></li>
									<li><a class="dropdown-item" href="/marketplace/vendor/orders.php">Orders</a></li>
									<li><a class="dropdown-item" href="/marketplace/vendor/annoucements.php">Announcements</a></li>
									<li><a class="dropdown-item" href="/marketplace/vendor/add.php">Add Product</a></li>
									<li><a class="dropdown-item" href="/marketplace/vendor/profile.php">Profile</a></li>
									<li><a class="dropdown-item" href="/marketplace/vendor/logout.php">Log out</a></li>
								</ul>
							</li>
						</ul>
					</ul>
						...
						<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									<i class="fas fa-bars fs-4 text-white"></i> </a>
								<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									<li><a class="dropdown-item" href="/marketplace/admin/admin.php">Dashboard</a></li>
									<li><a class="dropdown-item" href="/marketplace/admin/users.php">Users</a></li>
									<li><a class="dropdown-item" href="/marketplace/admin/announcements.php">Announcements</a></li>
									<li><a class="dropdown-item" href="/marketplace/admin/logout.php">Log out</a></li>
								</ul>
							</li>
						</ul>
					</ul>
